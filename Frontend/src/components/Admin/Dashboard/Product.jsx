                ...
                <Flex wrap="wrap" justify="center" align="flex-start">
                  {filteredProducts[category].map(product => (
                    ...
                    >
                      ...
                      <Text fontSize="lg" fontWeight="bold" color={colorMode === 'dark' ? 'gray.300' : 'black'}>
                        ₹ {product.price}
                      </Text>
...
/>
        ...
        <Modal isOpen={isOpen} onClose={handleCloseModal} size="lg">
          <ModalOverlay />
          <ModalContent zIndex={0}> {/* Ensure modal has higher z-index than the cards */}
              ...
              <FormControl mb={4}>
                ...
                <InputGroup>
                  ...
                  <InputRightElement width="4.5rem">
                    <Button h="1.75rem" size="sm" onClick={() => window.open(formData.img, "_blank")}>
                      View
                    </Button>
                  </InputRightElement>
                </InputGroup>
            ...
            <ModalFooter>
              <Button colorScheme="blue" mr={3} onClick={selectedProduct ? handleUpdateProduct : handleSaveProduct}>
